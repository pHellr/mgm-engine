...
static GOST_NID_JOB *missing_NIDs[] = {
    &kuznyechik_mgm_NID,
    &kuznyechik_mgm_b_NID,
    &kuznyechik_mgm_c_NID,
    &kuznyechik_mgm_cl_NID,
    &kuznyechik_mgm_cln_NID,
    &kuznyechik_mgm_clo_NID,
    &kuznyechik_mgm_clno_NID,
    &kuznyechik_mgm_a_NID,
    &kuznyechik_mgm_ab_NID,
    &kuznyechik_mgm_ad_NID,
    &kuznyechik_mgm_ac_NID,
    &kuznyechik_mgm_acl_NID,
    &kuznyechik_mgm_acln_NID,
    &kuznyechik_mgm_aclo_NID,
    &kuznyechik_mgm_aclno_NID,
    &magma_mgm_NID,
};
